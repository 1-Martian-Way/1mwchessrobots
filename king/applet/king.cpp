...
void draw_table()
{
   ...
   Serial.print("  ");
   Serial.print(pic, BYTE);
   //if (pic == 10 && i>0){Serial.print(i); i--;};
   }
...
void set_stage(char stg)
{
  ...
  if (stg == '/') {stage = '/'; attach_timer('/'); Serial.print('/', BYTE);}
  ...
  if (stg == 'x') {stage = 'x'; attach_timer('x'); Serial.print('x', BYTE);}
  
  /* Poll */
  if (stg == '~') {stage = '~'; attach_timer('~'); simple(2,2,1); poll(1);}
...
///////////////// SEND k_comp /////////////////////////////
 ...
 void send_k_comp() 
 {comp_flag = 1; Serial.print('^', BYTE); Serial.print('k', BYTE); pos_to_num(K);}
 
///////////////// SEND l_comp /////////////////////////////
 
 void send_l_comp() 
 {comp_flag = 1; Serial.print('^', BYTE); Serial.print('l', BYTE); pos_to_num(L);}
...
///////////////// SEND L /////////////////////////////
 ...
 if (stage == '/') Serial.print('/', BYTE);
 if (stage == 'x') Serial.print('x', BYTE);
 }
...
void print_len(int pc_len)
{
 ...
 if (comp_flag == 1) Serial.print(pc_len, BYTE);
}
 
void print_d1(int di_1)
{
 if (comp_flag == 0) Serial.print(di_1);
 if (comp_flag == 1) Serial.print(di_1, BYTE);
}

void print_d2(int di_2)
{
 if (comp_flag == 0) Serial.print(di_2);
 if (comp_flag == 1) Serial.print(di_2, BYTE);
}

void print_d3(int di_3)
{
 if (comp_flag == 0) Serial.print(di_3);
 if (comp_flag == 1) Serial.print(di_3, BYTE);
}
